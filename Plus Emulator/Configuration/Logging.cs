...
namespace Plus.Configuration
{
    ...
    public static class Logging
    {
        ...
        /// </summary>
        /// <param name="logText">The log text.</param>
        internal static void LogRpDebugging(string logText)
        {
            Writer.Writer.RpDebug(logText);
        }
        ...
        internal static void LogRPTimers(string logText)
        {
            //Writer.Writer.LogroleplayTimers(logText);
        }

        internal static void LogRPGames(string logText)
        {
            Writer.Writer.LogroleplayGames(logText);
        }
    }
}