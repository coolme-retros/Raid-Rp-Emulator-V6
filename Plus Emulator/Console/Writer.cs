...
namespace Plus.Writer
{
    public class Writer
    {
        ...
        {
            WriteToFile("Logs\\ExceptionsLog.txt", logText + "\r\n\r\n");
            WriteLine("RaidRp Emulator Threw an exception., Check Logs\\ExceptionsLog.txt for more information", ConsoleColor.Red);
        }
        ...
        public static void RpDebug(string logText)
        {
            WriteToFile("Logs\\rp_debug.txt", logText + "\r\n\r\n");
            WriteLine("[INFO] RP Debugging Saved: " + logText, ConsoleColor.Yellow);
        }
        ...
        public static void LogQueryError(Exception exception, string query)
        {
            ...
            {
                "Error in query check logs: \r\n",
                query,
                "\r\n",
                exception,
                "\r\n\r\n"
            }));
            WriteLine("[MySQL] A SQL query error has been logged, this may or may not be an error due.", ConsoleColor.Yellow);
        }
