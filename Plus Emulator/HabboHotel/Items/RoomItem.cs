            ...
            get
            {
                try
                {
                    if (this.GetBaseItem().StackMultipler && !string.IsNullOrWhiteSpace(ExtraData))
                    {
                        ...
                        return Z + Convert.ToDouble(GetBaseItem().ToggleHeight[num], System.Globalization.CultureInfo.InvariantCulture);
                    }
                ...
                case Interaction.QuickTeleport:
                {
                    ...
                    if (InteractingUser > 0)
                    {
                        ...
                        if (roomUserByHabbo2.Coordinate == Coordinate)
                        {
                            ...
                            else
                            {
                                ...
                                roomUserByHabbo2.GetClient().GetHabbo().IsTeleporting = false;
                    ...
                    if (InteractingUser2 > 0u)
                    {
                        ...
                        if (roomUserByHabbo3 != null)
                        {
                            ...
                            roomUserByHabbo3.GetClient().GetHabbo().IsTeleporting = false;
