    ...
    internal class PublicItem
    {
        ...
        internal RoomData RoomData
        {
            get
            {
                ...
                if (Plus.GetGame() == null || Plus.GetGame().GetRoomManager() == null) throw new NullReferenceException();
                return Plus.GetGame().GetRoomManager().GenerateRoomData(RoomId);
            }
        }
        ...
        internal RoomData RoomInfo
        {
            get
            {
                ...
                try
                {
                    result = RoomId > 0u ? Plus.GetGame().GetRoomManager().GenerateRoomData(RoomId) : null;
                }
                catch
                {
                    result = null;
                ...
                message.AppendInteger((ItemType == PublicItemType.None)
                    ...
                    : ((ItemType == PublicItemType.Tag)
                        ...
                        : ((ItemType == PublicItemType.Flat)
                            ...
                            : ((ItemType == PublicItemType.PublicFlat)
                                ? 2
                                : ((ItemType == PublicItemType.Category) ? 4 : 0)))));
                switch (ItemType)
                {
