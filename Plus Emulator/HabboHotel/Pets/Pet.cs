...
namespace Plus.HabboHotel.Pets
{
    ...
    internal class Pet
    {
        ...
        internal Room Room
        {
            get { return !IsInRoom ? null : Plus.GetGame().GetRoomManager().GetRoom(RoomId); }
        }
        ...
        internal int Age
        {
            get
            {
                var creation = Plus.UnixToDateTime(CreationStamp);
        ...
        {
            get { return Plus.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
