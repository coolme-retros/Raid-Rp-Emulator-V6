...
namespace Plus.Messages.Parsers
{
    ...
    internal class PacketLibrary
    {
        ...
        /// </summary>
        /// <param name="handler">The handler.</param> 
        internal static void CallPolice(GameClientMessageHandler handler)
        {
            handler.CallPolice();
        }
        ...
        internal static void BullyRequestAccept(GameClientMessageHandler handler)
        {
            handler.BullyRequestAccept();
        }
        internal static void BullyRequestVote(GameClientMessageHandler handler)
        {
            handler.BullyRequestVote();
        }
        internal static void BullyRequestNoVote(GameClientMessageHandler handler)
        {
            handler.BullyRequestNoVote();
        }
        internal static void GetCraftingRecipesAvailable(GameClientMessageHandler handler)
        {
            handler.GetCraftingRecipesAvailable();
        }
        internal static void CraftSecret(GameClientMessageHandler handler)
        {
            handler.CraftSecret();
        }
        internal static void SetCraftingRecipe(GameClientMessageHandler handler)
        {
            handler.SetCraftingRecipe();
        }
        internal static void ExecuteCraftingRecipe(GameClientMessageHandler handler)
        {
            handler.ExecuteCraftingRecipe();
        }
        internal static void GetCraftingItem(GameClientMessageHandler handler)
        {
            handler.GetCraftingItem();
        }
    }
}