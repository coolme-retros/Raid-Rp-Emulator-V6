...
{ 
    public static class RPDataHandler
    {
        /// <summary>
        /// log4net
        /// </summary>
        private static readonly ILog log = LogManager.GetLogger("Plus.HabboHotel.Roleplay.Misc");
        ...
        public static void LoadData()
        {
            ...
            using (var DB = Plus.GetDatabaseManager().GetQueryReactor())
            {
